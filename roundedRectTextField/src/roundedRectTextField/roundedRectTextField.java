...
import static roundedRectTextField.roundedColor.GRAY;

public class roundedRectTextField
        extends JTextField {

    public Color textfieldColor = GRAY;
    
    public roundedRectTextField() {
        setText("File Directory");
        setFont(new Font("Segoe UI", 0, 14));
        setPreferredSize(new Dimension(130, 35));
    }
    
    public roundedRectTextField(Color color)
    {
        setText("File Directory");
        setFont(new Font("Segoe UI", 0, 14));
        setPreferredSize(new Dimension(130, 35));
